    ...
    <div className="max-w-screen-xl mx-auto">
      ...
      <section className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {projects.map((item, i) => (
          <div
            key={i}
            className="bg-[#111141] rounded-xl shadow-lg overflow-hidden transform transition-transform hover:scale-[1.02]"
          >
            <img
              src={item.image}
              alt={item.title}
            ...
            />
            <div className="p-5">
              <h3 className="text-yellow-400 text-lg font-semibold mb-2">{item.title}</h3>
      ...
      <section className="text-center mt-16">
        <h2 className="text-2xl font-bold mb-2">Let’s Build Something Remarkable</h2>
